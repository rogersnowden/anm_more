...
export default function Login() {
  ...
  const handleForgotPassword = (event) => {
    ...
    // turn off login form, for now
    setShowComponent(false);
  };

  const handleVerificationSuccess = () => {
    setPasswordVerifyOpen(false); // Close verification form
    setPasswordResetOpen(true);  // Open password reset form
  };
...
//    event.preventDefault();
  ...
  return (
    <div className={classes.root}>
        ...
        <>
          ...
          <AnmPasswordRecover
            ...
            onSuccess={(email) => {
              ...
              setResetEmail(email); // Save email for verification
              setPasswordVerifyOpen(true); // Open verification form
            }}
          />
        </>
      )}
      ...
      <AnmPasswordVerify
        username={resetEmail}
        onClose={() => setPasswordVerifyOpen(false)}
      ...
      {passwordResetOpen && (
        ...
        onSuccess={() => {
          ...
          setShowComponent(true); // Show login form
        }}
      />
      )}  
      {/* Registration Form */}
