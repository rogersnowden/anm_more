...
export default function AnmLevel() {
  ...
  const updateAudioLevel = () => {
    ...
    // Continue updating the decibel meter while recording
  ...
  return (
    <Box>
      <Typography variant="h5">Adjust Microphone Levels and Record Audio</Typography>
      <Box>
        <Typography variant="body1">
          Please read the following sentence out loud to test your recording level:
        </Typography>
