...
//      setCurrentPageTextColor(pageTextColorArray[currentPageIndex]);
  ...
  // post audio to server
    ...
    function preloadImagesForNextPages(currentPageIndex, userBook) {
      console.log("preloadImagesForNextPages 1");
      ...
      const startPage = currentPageIndex + 1; // Start from the next page
      ...
      for (let i = startPage; i < endPage; i++) {
        ...
        if (page && page.image) {
          ...
          preloadLink.href = BaseURI + 'src/' + page.image; // Adjust if your image URL construction is different
