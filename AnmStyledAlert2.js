...
export default function AnmStyledAlert2({ open, onClose, alertMessage }) {
  ...
  useEffect(() => {
    console.log("AnmStyledAlert2 rendered with open:", open);
    return () => {
      console.log("AnmStyledAlert2 unmounting");
    };
  }, [open]);
